...
def process(images_montgomery,labels_montgomery,images_china,labels_china,num_normal_montgomery,num_abnormal_montgomery,num_normal_china,num_abnormal_china):
    ...
    save_dir = "/home/obayraktar/work/labeled/aug"  # Replace with your desired directory
    ...
    augmented_images_montgomery, augmented_labels_montgomery = augment_data(images_montgomery, 
                                                                            labels_montgomery, 
    ...
    return images_montgomery,labels_montgomery,images_china,labels_china,augmented_images_montgomery,augmented_labels_montgomery